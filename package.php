  ...
  <section class="home-section">
    <nav>
      <div class="sidebar-button">
        ...
        <span class="dashboard">Record of Packages</span>
      </div>
      ...
      <div class="modal fade" id="myModal2">
        <div class="modal-dialog modal-lg">
          <div class="modal-content col-9 mx-auto">
            ...
            <!-- modal header -->
            <div class="modal-header">
              <h4 class="modal-title" style=" font-family: 'Barlow Condensed', sans-serif; font-size:30px; margin-top:2%;">Add Package</h4>
            ...
            <?php
               ...
               {  
                  ...
                  {
                    $status = "Available";
                    $add_Package = new DEPED();
                    $add_Package -> insert_item($item_id, $item_name, $particular, $quantity, $cost, $purchase_date, $category, $status);
                    
                    if($add_Package)
                      {
                        echo '<script>window.location.href = "/depedmanila/package.php"</script>';
                      }
         ...
         <div class="tab-title" style="margin-top:100px;">
              ...
              <tbody id="prodTable">
                ...
                <?php
                    ...
                    $query = "SELECT * FROM item WHERE category = 'Packages'";
              ...
              <form action="" method="post">
                  ...
                  <?php
                    ...
                    { 
                      ...
                      $del_package = new DEPED();
                      $del_package -> delete_item($item_id);
