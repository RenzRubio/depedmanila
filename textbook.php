...
<html lang="en" dir="ltr">
  <head>
    <meta charset="UTF-8">
    <title>Deped | Add Textbooks</title>
  ...
  <section class="home-section">
    <nav>
      <div class="sidebar-button">
        ...
        <span class="dashboard">Record of Textbooks</span>
      </div>
      ...
      <div class="modal fade" id="myModal2">
        <div class="modal-dialog modal-lg">
          <div class="modal-content col-9 mx-auto">
            ...
            <!-- modal header -->
            <div class="modal-header">
              <h4 class="modal-title" style=" font-family: 'Barlow Condensed', sans-serif; font-size:30px; margin-top:2%;">Add Textbooks</h4>
            ...
            <?php
               ...
               {  
                  ...
                  {
                    $status = "Available";
                    $add_textbook = new DEPED();
                    $add_textbook -> insert_item($item_id, $item_name, $particular, $quantity, $cost, $purchase_date, $category, $status);
                    
                    if($add_textbook)
                    {
                        echo '<script>window.location.href = "/depedmanila/textbook.php"</script>';
                    }
         ...
         <div class="tab-title" style="margin-top:100px;">
              <!--<p style="font-family: 'Viga', sans-serif; color: #37323E; font-size: 20px; font-style: italic;">Record of Textbooks</p>
              -->   
              ...
              <tbody id="prodTable">
                ...
                <?php
                    ...
                    $query = "SELECT * FROM item WHERE category = 'Textbooks'";
              ...
              <form action="" method="post">
                  ...
                  <?php
                    ...
                    { 
                      ...
                      $del_textbook = new DEPED();
                      $del_textbook -> delete_item($item_id);
