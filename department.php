...
<html lang="en" dir="ltr">
  <head>
    <meta charset="UTF-8">
    <title>Deped | Add Department</title>
...
<body>
  ...
  <div class="sidebar">
    ...
    <ul class="nav-links">
        ...
        <li>
          <a href="department.php" class="active">
  ...
  <section class="home-section">
    <nav>
      <div class="sidebar-button">
        ...
        <span class="dashboard">Add New Department</span>
      </div>
  ...
  <div class="modal fade" id="logoutModal">
   ...
   <!--- error
      ...
      <button type="button" class="btn-modal btn-lg" data-toggle="modal" data-target="#myModal2" style="background: rgb(60,141,188);font-size: 16px; margin-left:2%; margin-top: 2%;">+ Add Department</button>
  ...
  <thead class="table-warning" style="background-color:rgb(171, 207, 228); ">
    <tr>
      ...
      <th onclick="sortTable(0)"scope="col">Department Description</th>
              ...
              <form action="" method="post">
                  ...
                  <?php
                    ...
                    { 
                      ...
                      $del_position ->delete_department($id);
                    }
    ...
    <!--Ending-->
        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content col-9 mx-auto">
            ...
            <!-- modal header -->
            <div class="modal-header">
            <h4 class="modal-title" style=" font-family: 'Barlow Condensed', sans-serif; font-size:35px; margin-top:2%;">Edit Department</h4>
            ...
            <form action="" method="post" enctype = "multipart/form-data">
              ...
              <label for="position">Department: </label>
                <input type="hidden" name='id' class="form-control validate" id="" value = "<?php echo $row['id']?>" placeholder = "School ID" style = "width:100%; height:20%;" ><br>

                <input type="text" name='department_name' class="form-control validate" value = "<?php echo $row['department']?>" placeholder = "School ID" style = "width:100%; height:20%;">
            ...
            <div class="modal-footer">
              ...
              //updating school
                ...
                if(isset($_POST['update-btn']))
                {
                    ...
                    echo '<script>window.location.href = "/depedmanila/department.php"</script>';
