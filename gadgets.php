  ...
  <section class="home-section">
    <nav>
      <div class="sidebar-button">
        ...
        <span class="dashboard">Record of Tablets/Mobile Devices</span>
      </div>
      ...
      <div class="modal fade" id="myModal2">
        <div class="modal-dialog modal-lg">
          <div class="modal-content col-9 mx-auto">
            ...
            <!-- modal header -->
            <div class="modal-header">
              <h4 class="modal-title" style=" font-family: 'Barlow Condensed', sans-serif; font-size:30px; margin-top:2%;">Add Gadgets</h4>
            ...
            <?php
               ...
               {  
                  ...
                  {
                    $status = "Available";
                    $add_Gadget = new DEPED();
                    $add_Gadget -> insert_item($item_id, $item_name, $particular, $quantity, $cost, $purchase_date, $category, $status);
                    
                    if($add_Gadget)
                    {
                      echo '<script>window.location.href = "/depedmanila/gadgets.php"</script>';
                    }
         ...
         <div class="tab-title" style="margin-top:100px;">
              <!--<p style="font-family: 'Viga', sans-serif; color: #37323E; font-size: 20px; font-style: italic;">Record of Packages</p>
              -->
              ...
              <tbody id="prodTable">
                ...
                <?php
                    ...
                    $query = "SELECT * FROM item WHERE category = 'Gadgets'";
              ...
              <form action="" method="post">
                  ...
                  <?php
                    ...
                    { 
                      ...
                      $del_gadgets = new DEPED();
                      $del_gadgets -> delete_item($item_id);
