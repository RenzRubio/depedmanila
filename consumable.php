...
<html lang="en" dir="ltr">
  <head>
    <meta charset="UTF-8">
    <title>Deped | Add Consumable</title>
...
<body>
  ...
  <div class="sidebar">
    ...
    <ul class="nav-links">
        ...
        <div class="dropdown-container" id="myDropdown" class="active"class="dropdown-content">
  ...
  <section class="home-section">
    <nav>
      <div class="sidebar-button">
        ...
        <span class="dashboard">Consumables</span>
      </div>
  ...
  <div class="modal fade" id="logoutModal">
   ...
   <!--- error
      <!--button to open modal -->
       ...
       <!---Table Consumables--->
        <button type="button" class="btn-modal btn-lg" data-toggle="modal" data-target="#myModal" style="background: rgb(60,141,188);font-size: 16px; margin-left:2%; margin-top: 2%;">+ Add Item</button>
      ...
      <div class="modal fade" id="myModal">
        <div class="modal-dialog modal-lg">
          <div class="modal-content col-9 mx-auto">
            ...
            <!-- modal header -->
            <div class="modal-header">
              <h4 class="modal-title" style=" font-family: 'Barlow Condensed', sans-serif; font-size:30px; margin-top:2%;">Add Consumable</h4>
          ...
          <form action="" method="post">
            ...
            <input type="text"  name='itemID' class="form-control validate" id="" value = "" style = "width:100%; height:20%;"><br>
            ...
            <center><button class="btnadd" name= 'add-consumable'>Add Item</button></center>

            <?php
            
                if(isset($_POST['add-consumable']))
                {
                    ...
                    {
                      $status = "Available";
                      $add_Consumable = new DEPED();
                      $add_Consumable -> insert_item($item_id, $item_name, $particular, $quantity, $cost, $purchase_date, $category, $status);
                      
                      if($add_Consumable)
                      {
                        echo '<script>window.location.href = "/depedmanila/consumable.php"</script>';
                      }
          ...
          <div class="tab-title" style="margin-top:100px;">
              <!---<p style="font-family: 'Viga', sans-serif; color: #37323E; font-size: 20px; font-style: italic;">Record of Consumables</p>
                 --->
              <div class="product-table ">
              <table id="prdctTable" style="width:118%;"class="table bg-white table-hover">
              <thead class="table-warning" style="background-color:rgb(60, 141, 188); ">
                <tr>
          ...
          $query = "SELECT * FROM item WHERE category = 'Consumable'";
          ...
          while($row = mysqli_fetch_array($display_emp))
          {
            ...
            <td scope="row" style=" line-height: 50px;"><?php echo $row['item_id']?></td>
            <td colspan="1" style=" line-height: 50px;"><?php echo $row['item_name']?></td>
            <td scope="row" style=" line-height: 50px;"><?php echo $row['quantity'].' pcs'?></td>
            <td style="line-height: 50px;"><?php echo $row['particular']?></td>
            ...
            ?></td>
            <td style="line-height: 50px;"><?php echo $row['category']?></td>
            
            <td style= "display:none; line-height: 50px;"><?php echo $row['quantity']?></td>
            <td style= "display:none; line-height: 50px;"><?php echo $row['cost']?></td>
            <td style= "display:none; line-height: 50px;"><?php echo $row['purchase_date']?></td>
        
              
            <td>
              <form action="/depedmanila/checkout.php" method="get">
              
                <!---<button type="button" ><i class="las la-clipboard-list"></i></div></button>--->
                <?php
              ...
              <button type="button" class="btn editbtnconsumable" data-toggle="modal" data-target="#editModalconsumable<?php echo $row['item_id']?>"><div class="icons8-edit"></div></button>
              <button type="button" class="btn deletebtnconsumable"  data-toggle="modal" data-target="#delModalconsumable<?php echo $row['item_id']?>"><div class="icons8-trash"></div></button><br>
...
<div class="modal fade" id="delModalconsumable<?php echo $row['item_id']?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1">
          ...
          <!-- Modal footer -->
            <div class="modal-footer">
              ...
              <form action="" method="post">
                  ...
                  <input type="hidden" name='itemId' id="itemId" value = "<?php echo $row['item_id']?>">
                  ...
                  <?php
                    ...
                    { 
                      ...
                      $delete_cons = new DEPED();
                      $delete_cons -> delete_item($item_id);
...
<!---ending--->
    ...
    <div class="modal fade" id="editModalconsumable<?php echo $row['item_id']?>">
        <div class="modal-dialog modal-lg">
          <div class="modal-content col-9 mx-auto">

            <!-- modal header -->
            <div class="modal-header">
            <h4 class="modal-title" style=" font-family: 'Barlow Condensed', sans-serif; font-size:35px; margin-top:2%;">Edit Consumable Information</h4>
          ...
          <form action="" method="post">
              ...
              <input type="text" disabled name='' class="form-control validate" id="item_id" value = "<?php echo $row['item_id']?>" placeholder = "Item ID" style = "width:100%; height:20%;"><br>
              <input type="hidden" name='item_id' id = 'itemid' value = "<?php echo $row['item_id']?>" >

              <label>Item Name:</label>
              <input type="text" name='itemName' class="form-control validate" id="itemName" value = "<?php echo $row['item_name']?>" placeholder = "Item Name" style = "width:100%; height:20%;"><br>
                
            <label for="">Particular: </label><br>
              <textarea name='particular' id="particular" style="width: 100%;" ><?php echo $row['particular']?></textarea><br>

            <label>Quantity: </label>
              <input type="number" name='quantity' class="form-control validate" id="quantity" value = "<?php echo $row['quantity']?>" placeholder = "Quantity" style = "width:100%; height:20%;"><br>
            
            <label>Cost: </label>
              <input type="text" name='cost' class="form-control validate" id="cost" value = "<?php echo $row['cost']?>" placeholder = "Cost" style = "width:100%; height:20%;"><br>
